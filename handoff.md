...
**piece 001 第一版**(2026-07-22)未封版 — **5 天規則到期日 2026-07-27(明天)**。
今天內要嘛動它、要嘛封版。目前傾向:001 的命題(刻床)已被 002 接走並推進,
繼續加東西大概只是裝飾 → 封版候選。決定權在下一個 session。
...
- **001 決定(急,明天到期)**:封版(傾向)或最後一次 iteration。封版=固定 URL + README 一段。
